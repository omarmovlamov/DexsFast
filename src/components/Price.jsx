    ...
    <section id="price">
      <div className="p-10 flex flex-wrap">
        <div className="w-100pc md-w-50pc">
          <div className="p-5">
            <h4 className="white fw-800 fs-l3 mb-5">DexsFast Pricing</h4>
            <div className="orange-lightest fw-600 fs-m1 opacity-50">
              We offer our solutions to improve the details of your website with
              units and options suitable for you.
            </div>
            <h4 className="white fw-600 fs-m2 mt-10">Companies trusts us.</h4>
            <div className="flex orange-lightest opacity-50">
        ...
        <div className="w-100pc md-w-25pc">
          <div className="m-3 p-5 br-8 bg-orange-lightest-10 overflow-hidden">
            <div className="p-3">
              <h3 className="clr-orange">Free</h3>
              <div className="white flex items-center">
                $<span className="fs-l5 lh-1">0</span>/mo
              </div>
            </div>
            <div className="p-3 orange-lightest fw-400 fs-s1 lh-5">
              <div>
                <i
                  className="fa-solid fa-check h-3 clr-orange"
                  data-feather="check"
                ></i>
        ...
        <div className="w-100pc md-w-25pc">
          <div className="m-3 p-5 br-8 bg-white overflow-hidden">
            <div className="p-3">
              <h3 className="clr-orange">Pro</h3>
            ...
            <div className="p-3">
              <button className="button full bg-price white hover-opacity-100 hover-scale-up-1 ease-300">
                SIGN UP
              </button>
            </div>
          </div>
